...
Ce guide pas-à-pas décrit la configuration nécessaire pour compiler et utiliser **ESP32-Diagnostic v2.8.11** avec l'IDE Arduino 2.x.
...
| Voyants WiFi/Bluetooth incohérents | Rechargez l'onglet « Sans fil » ou la page ; la v2.8.11 convertit désormais correctement les booléens renvoyés par le firmware pour synchroniser les voyants avec l'état réel. |
