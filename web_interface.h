...
String generateJavaScript() {
  ...
  js += "const fallbackTranslations={fr:{loading:'Chargement...',error_title:'❌ Erreur',update_indicator:'Mise à jour...',language_changed:'Langue changée',language_error:'Erreur changement langue',click_to_scan:'Cliquez pour scanner',displaying:'Affichage en cours...',command_sent:'Commande envoyée',communication_error:'Erreur de communication',test_result_title:'Résultat du test',close:'Fermer',enter_text:'Entrez un texte !',enter_message:'Entrez un message !',gpio_warning_note:'Un test GPIO en échec peut simplement indiquer qu\'un périphérique est déjà connecté sur cette broche et ne signifie pas forcément une défaillance de la carte.',gpio_test_summary:'Test GPIO terminé : {ok} OK / {fail} en échec'},en:{loading:'Loading...',error_title:'❌ Error',update_indicator:'Updating...',language_changed:'Language changed',language_error:'Language change error',click_to_scan:'Click to scan',displaying:'Displaying...',command_sent:'Command sent',communication_error:'Communication error',test_result_title:'Test result',close:'Close',enter_text:'Please enter text!',enter_message:'Please enter a message!',gpio_warning_note:'A failed GPIO test can simply mean a peripheral already uses that pin and does not always indicate a faulty board.',gpio_test_summary:'GPIO test completed: {ok} OK / {fail} failed'}};";
