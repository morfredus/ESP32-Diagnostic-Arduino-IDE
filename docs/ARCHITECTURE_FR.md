...
- La maintenance 3.1.14-maint augmente la réserve utilisée par `htmlEscape` pour absorber les pires cas d'échappement d'entités HTML dans les chaînes exportées.
