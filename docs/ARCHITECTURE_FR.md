...
- La version 3.2.0 conserve le handler `/api/set-language` renforcé, maintient la préallocation de `jsonEscape` et documente la scission du changelog bilingue pour les mainteneurs.
