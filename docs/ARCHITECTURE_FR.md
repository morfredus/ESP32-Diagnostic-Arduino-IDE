...
- La version 3.2.22-dev réaffirme le handler `/api/set-language` renforcé, conserve l'historique consolidé au sein du firmware et maintient l'alignement du changelog bilingue avec la bannière de version actualisée.
