...
- La version 3.1.18 renforce le handler `/api/set-language` avec des réponses succès/erreur explicites tout en préallouant `jsonEscape` pour garder les exports efficaces.
