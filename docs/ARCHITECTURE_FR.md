...
- La version 3.4.11 insiste sur le rafraîchissement client des traductions qui réapplique le catalogue en temps réel sur les onglets de diagnostics et les exports tout en conservant les mêmes endpoints REST.
