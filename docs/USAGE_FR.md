...
La version 3.5.1 finalise le pipeline de traduction en direct : chaque onglet (Vue d'ensemble, tests avancés, sans fil, GPIO, performances, exports) se met à jour instantanément lors d'un changement de langue.
...
- Exploitez l'endpoint `/api/memory-details` lorsque les exports signalent une fragmentation et vérifiez que les libellés traduits se mettent à jour en basculant de langue sous la version 3.5.1.
...
## 8. Checklist de débogage post-release (3.5.1)
