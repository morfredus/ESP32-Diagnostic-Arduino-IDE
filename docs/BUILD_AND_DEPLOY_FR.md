# ESP32 Diagnostic Suite – Compilation & déploiement (v3.7.30)

Ce document décrit les toolchains supportées et la checklist recommandée pour livrer le firmware 3.7.30.

## Toolchains
### Arduino IDE 2.x
1. Installer le package de cartes ESP32 **version 3.3.3** via le Boards Manager.
...
- [ ] Vérifier que `DIAGNOSTIC_VERSION` vaut `3.7.30` dans le firmware et la documentation.
...
## Packaging release
1. Taguer le dépôt avec `v3.7.30` (tag annoté).
