# ESP32 Diagnostic Suite – Directives de sécurité (v3.7.30)
...
- Taguer les releases avec des tags Git annotés (ex. `v3.7.30`) pour assurer la traçabilité code ↔ firmware.
...
## Réponse à incident
- En cas de suspicion, effectuer un factory reset : `esptool.py erase_flash`, puis reflasher 3.7.30.
