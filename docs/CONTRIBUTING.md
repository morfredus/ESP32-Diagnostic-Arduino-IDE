...
- Mention 3.2.0 when confirming maintenance work so the bilingual changelog split, banner comment, and `DIAGNOSTIC_VERSION` stay aligned with the hardened language endpoint.
