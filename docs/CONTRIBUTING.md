...
## Code contributions
1. **Fork** – start from your GitHub fork: [morfredus/ESP32-Diagnostic-Arduino-IDE](https://github.com/morfredus/ESP32-Diagnostic-Arduino-IDE/fork).
...
- Mention 3.8.0 when confirming maintenance work so the Wi-Fi splash, NimBLE safeguards, bilingual changelog, and `DIAGNOSTIC_VERSION` remain aligned.

## Issue reporting
File bug reports via [GitHub Issues](https://github.com/morfredus/ESP32-Diagnostic-Arduino-IDE/issues/new/choose) and include:
