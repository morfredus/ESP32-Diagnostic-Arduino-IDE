...
- Mention 3.5.0 when confirming maintenance work so the live translation bindings, bilingual changelog, and `DIAGNOSTIC_VERSION` remain aligned with the refreshed language-switch workflow.
