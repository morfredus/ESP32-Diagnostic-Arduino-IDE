...
> **Release 3.1.18:** Confirm the firmware banner and `DIAGNOSTIC_VERSION` constant report 3.1.18 so the hardened language endpoint and refreshed exports stay aligned.
