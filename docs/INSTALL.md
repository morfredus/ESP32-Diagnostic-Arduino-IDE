...
> **Release 3.2.0:** Confirm the firmware banner and `DIAGNOSTIC_VERSION` constant report 3.2.0, then trigger `/api/memory-details` once to validate the refreshed fragmentation guidance documented in this release.
