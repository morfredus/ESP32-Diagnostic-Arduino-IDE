...
- Release 3.5.1 guarantees that placeholders (e.g., "Non testé"), status chips, and export actions reuse the shared catalog and update instantly whenever you toggle between French and English.
