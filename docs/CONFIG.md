...
- Release 3.1.19 keeps the accented "Non testé" placeholders aligned, preserves the explicit HTTP 200/400 responses on `/api/set-language`, and updates links to the bilingual changelog pair.
