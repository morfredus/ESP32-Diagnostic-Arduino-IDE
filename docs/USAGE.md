...
- Release 3.1.20 documents the `/api/memory-details` inspector, folds in the Bluetooth/Wi-Fi debugging checklist, and keeps the sticky masthead aligned with the bilingual changelog.
...
- Use the `/api/memory-details` endpoint when reports warn about fragmentation; the JSON response mirrors the guidance documented in 3.1.20.
...
## 8. Post-release debugging checklist (3.1.20)
