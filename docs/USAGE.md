...
- Download TXT/JSON/CSV exports and verify the filenames embed version 3.8.0 while the BLE and Wi-Fi sections reflect the refreshed compatibility guidance.
