...
- Assurez-vous d'exécuter le firmware 3.1.18 afin que `/api/set-language` renvoie des succès explicites (FR/EN) et un HTTP 400 pour les codes non pris en charge.
...
- Passez en version 3.1.18 (ou toute maintenance 3.x ultérieure) pour rétablir l'intitulé « Non testé » et appliquer les traductions du bandeau sticky sur tous les supports.
