...
- La version 3.7.30 conserve le catalogue partagé synchronisé tout en ajoutant l'écran Wi-Fi et les garde-fous NimBLE sans configuration supplémentaire.
...
- NimBLE est sélectionné automatiquement sur les cartes ESP32-S3 et les cibles USB ; en 3.7.30, les résultats de scan sont validés avant exposition, évitant toute manipulation manuelle.
