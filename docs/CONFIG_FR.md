...
- La version 3.1.18 maintient l'intitulé accentué « Non testé » et impose des réponses HTTP 200/400 explicites sur `/api/set-language` lors du basculement de langue.
