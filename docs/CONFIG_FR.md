...
- La version 3.4.11 garantit que les intitulés (ex. « Non testé »), cartouches de statut et actions d'export réutilisent le catalogue commun et se mettent à jour instantanément lorsque vous changez de langue.
