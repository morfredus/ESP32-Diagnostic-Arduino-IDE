...
- La version 3.1.20 conserve l'intitulé accentué « Non testé », réaffirme les réponses HTTP 200/400 explicites de `/api/set-language` et documente la vérification du changelog bilingue après bascule.
