...
- La version 3.2.0 conserve l'intitulé accentué « Non testé », préserve les réponses HTTP 200/400 explicites de `/api/set-language` et actualise les liens vers le duo de changelog bilingue.
