...
- La version 3.4.0 conserve l'intitulé accentué « Non testé », valide l'harmonisation du catalogue FR/EN et s'appuie sur les helpers JSON mutualisés pour garantir des exports cohérents après changement de langue.
