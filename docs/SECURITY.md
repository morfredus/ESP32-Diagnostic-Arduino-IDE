# ESP32 Diagnostic Suite – Security Guidelines (v3.8.0)
...
- Tag releases with annotated Git tags (e.g., `v3.8.0`) to ensure traceability between code and deployed firmware.
