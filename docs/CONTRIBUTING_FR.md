...
- Rappelez la version 3.3.0 lors des travaux de maintenance afin de garder synchronisés le duo de changelog bilingue, le commentaire de version, `DIAGNOSTIC_VERSION` ainsi que la documentation sur l'historique consolidé et le handler de langue.
