...
- Rappelez la version 3.3.11 lors des travaux de maintenance afin de garder synchronisés les helpers JSON mutualisés, le duo de changelog bilingue, `DIAGNOSTIC_VERSION` et le handler de langue renforcé.
