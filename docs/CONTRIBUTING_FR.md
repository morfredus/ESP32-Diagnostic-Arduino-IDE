...
- Rappelez la version 3.2.0 lors des travaux de maintenance afin de garder synchronisés le duo de changelog bilingue, le commentaire de version, `DIAGNOSTIC_VERSION` et le handler de langue durci.
