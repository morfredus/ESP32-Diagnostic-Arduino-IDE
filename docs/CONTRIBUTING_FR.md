...
- Rappelez la version 3.4.11 lors des travaux de maintenance afin de garder synchronisés les liaisons de traduction en direct, le duo de changelog bilingue, `DIAGNOSTIC_VERSION` et le flux de changement de langue actualisé.
