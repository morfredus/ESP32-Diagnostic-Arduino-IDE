...
> **Maintenance 3.1.15-maint :** Vérifiez que le bandeau de version et la constante `DIAGNOSTIC_VERSION` annoncent 3.1.15-maint afin d'aligner les noms de fichiers d'export et les journaux série.
