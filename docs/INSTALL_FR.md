...
> **Version 3.8.0 :** Vérifiez que le bandeau de version et la constante `DIAGNOSTIC_VERSION` affichent 3.8.0, observez l'écran OLED (si présent) afficher les phases de connexion Wi-Fi (association, DHCP, réussite) et confirmez que la compilation NimBLE se déroule sans erreur sur votre ESP32 ou ESP32-S3.
