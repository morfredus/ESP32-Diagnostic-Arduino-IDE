...
> **Version 3.3.11 :** Vérifiez que le bandeau de version et la constante `DIAGNOSTIC_VERSION` indiquent 3.3.11, puis validez `/api/memory-details` et l'UI bilingue afin de confirmer l'activation des helpers JSON mutualisés et des correctifs de traduction.
