# ESP32 Diagnostic Suite – Build & Deploy (v3.8.0)

This document describes the supported toolchains and the recommended release checklist for firmware version 3.8.0.
...
## Release packaging
1. Tag the repository with `v3.8.0` (Git annotated tag).
