...
- Release 3.4.11 emphasises the client translation refresher that reapplies catalog entries in real time across diagnostics tabs and exports while keeping the backend REST surface unchanged.
