...
- Release 3.7.30 introduces the Wi-Fi splash layer and shared BLE scan helpers, keeping the scheduler identical whether the board uses Bluedroid or NimBLE.
