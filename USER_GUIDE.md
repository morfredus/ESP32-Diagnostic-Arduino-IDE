...
This checklist describes everything required to build and run **ESP32-Diagnostic v2.8.9** with the Arduino IDE 2.x toolchain.
...
| Wireless banner shows the wrong dot colour | Reload the page or click “Sans fil”; v2.8.9 keeps WiFi/Bluetooth indicators in sync and reports disabled Bluetooth as offline. |
