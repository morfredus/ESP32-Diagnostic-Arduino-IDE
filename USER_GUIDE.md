...
| Wireless banner shows the wrong dot colour | Reload the page or click “Sans fil”; v2.8.12 keeps WiFi/Bluetooth indicators in sync, retries every configured SSID sequentially and surfaces the IP badge plus Bluetooth status hints. |
