...
| Wireless banner shows the wrong dot colour | Reload the page or click “Sans fil”; v2.8.10 keeps WiFi/Bluetooth indicators in sync, surfaces the IP badge and reports disabled Bluetooth as offline. |
