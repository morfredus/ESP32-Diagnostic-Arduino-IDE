...
## Highlights of version 3.2.22-dev
...
- Aligned the firmware header comment and `DIAGNOSTIC_VERSION` macro at 3.2.22-dev to preserve consistent logging across serial output and exports.
